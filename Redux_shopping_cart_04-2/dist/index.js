...
/******/ 	__webpack_require__.p = "C:\\Users\\Taro\\Desktop\\shop_cart\\dist";
/******/
/******/
...
/*!******************************!*\
  !*** ./src/actions/index.js ***!
  \******************************/
/*! exports provided: getAllProducts, displayState, addToCart, checkout */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAllProducts", function() { return getAllProducts; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "displayState", function() { return displayState; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addToCart", function() { return addToCart; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkout", function() { return checkout; });
/* harmony import */ var _api_shop__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../api/shop */ "./src/api/shop.js");
...
const getAllProducts = () => d => {
    // コールバックが引数。実行時、商品データの配列が入る。api/products.json
    _api_shop__WEBPACK_IMPORTED_MODULE_0__["default"].getProducts(products => d({
        type: _constants_ActionTypes__WEBPACK_IMPORTED_MODULE_1__["RECEIVE_PRODUCTS"],
        products
    }));
};
//引数2個を受ける関数を返す関数。
// この引数には実行時、dとgにはdispatchとgetStateが割り当てられる。
const displayState = () => (d, g) => {
    console.log(g());
};
//実行時、dとgにはdispatchとgetStateが割り当てられる。
//g すなわち getState() は　state tree を返す。
const addToCart = productId => (d, g) => {
    if (g().products.byId[productId].inventory > 0) {
        d({
            type: _constants_ActionTypes__WEBPACK_IMPORTED_MODULE_1__["ADD_TO_CART"],
            productId
        });
    }
};
//実行時、dとgにはdispatchとgetStateが割り当てられる。
//g すなわち getState() は　state tree を返す。
const checkout = products => (d, g) => {
    // stateからstate.cartだけ取り出し
    const { cart } = g();
    const paid = Object(_reducers__WEBPACK_IMPORTED_MODULE_2__["getTotal"])(g());
    d({
        type: _constants_ActionTypes__WEBPACK_IMPORTED_MODULE_1__["CHECKOUT_REQUEST"]
    });

    _api_shop__WEBPACK_IMPORTED_MODULE_0__["default"].buyProducts(products,
    //とりあえずここでは、無条件に成功するようにしておく。
    //このコールバック関数は、サーバー側の決済処理が成功すれば、成功のdispatch
    // 失敗すれば失敗のdispatchをする関数にするべきだろう
    () => {
        d({
            type: _constants_ActionTypes__WEBPACK_IMPORTED_MODULE_1__["CHECKOUT_SUCCESS"],
            paid,
            cart
        });
    }
...
module.exports = [{"id":1,"title":"メロン","price":900,"inventory":2},{"id":2,"title":"すいか","price":300,"inventory":10},{"id":3,"title":"ミカン","price":200,"inventory":5}];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _products_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./products.json */ "./src/api/products.json");
var _products_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./products.json */ "./src/api/products.json", 1);


const TIMEOUT = 100;

/* harmony default export */ __webpack_exports__["default"] = ({
    getProducts: (cb, timeout) => setTimeout(() => cb(_products_json__WEBPACK_IMPORTED_MODULE_0__), timeout || TIMEOUT),
    buyProducts: (_payload, cb, timeout) => setTimeout(() => cb(_products_json__WEBPACK_IMPORTED_MODULE_0__), timeout || TIMEOUT)
});
...
const Cart = ({ products, total, onCheckoutClicked }) => {
  ...
  const nodes = hasProducts ? products.map(product => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Product__WEBPACK_IMPORTED_MODULE_2__["default"], {
    title: product.title,
    price: product.price,
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
    'div',
    { className: 'border border-dark alert alert-secondary rounded p-1 clearfix mx-auto', style: { width: '30em' } },
    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
      'h5',
    ...
    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
      'p',
      { className: 'text-white bg-dark text-center', style: { marginLeft: "20em" } },
      '\u5408\u8A08: \xA5',
      total
    ),
    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
      'button',
      { className: 'btn btn-danger float-right', onClick: onCheckoutClicked,
...
Cart.propTypes = {
  ...
  total: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string,
  onCheckoutClicked: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func.isRequired
};
...
//個々の商品情報の表示部分
const Product = ({ price, quantity, title }) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
    'div',
    { className: 'clearfix mb-1' },
    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        'span',
        { className: 'p-1  bg-success text-white rounded m1 float-left' },
        title
    ),
    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        'span',
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
            'span',
            { className: 'float-right w-25 text-right' },
            quantity ? `  ${quantity}個` : `0個`
        ),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
            'span',
            { className: 'float-right w-25 mr-3' },
            '\xA5',
            price
        )
    )
...
Product.propTypes = {
    ...
    quantity: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number,
...
//個々の商品データを入れる入れ物
// カートに入れるためのボタンもつける
const ProductItem = ({ product, onAddToCartClicked }) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
  'div',
  { className: 'clearfix p-1 rounded mx-auto', style: { marginBottom: 5, width: '30em', border: '5px solid #eee' } },
...
ProductItem.propTypes = {
  product: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.shape({
    ...
    inventory: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number.isRequired
  }).isRequired,
  onAddToCartClicked: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func.isRequired
};
...
const ProductsList = ({ title, children, onClick_displayState }) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
  'div',
  { className: 'mx-auto' },
  react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
    'h5',
  ...
  react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
    'button',
    { className: 'btn btn-primary mx-auto d-block mb-1', style: { width: "6em" }, onClick: onClick_displayState },
    'state \u8868\u793A'
  )
);
...
ProductsList.propTypes = {
  ...
  title: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string.isRequired,
  onClick_displayState: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func.isRequired
};
...
/*!**************************************!*\
  !*** ./src/constants/ActionTypes.js ***!
  \**************************************/
/*! exports provided: RECEIVE_PRODUCTS, ADD_TO_CART, CHECKOUT_REQUEST, CHECKOUT_SUCCESS, CHECKOUT_FAILURE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CHECKOUT_REQUEST", function() { return CHECKOUT_REQUEST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CHECKOUT_SUCCESS", function() { return CHECKOUT_SUCCESS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CHECKOUT_FAILURE", function() { return CHECKOUT_FAILURE; });
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _ProductsContainer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ProductsContainer */ "./src/containers/ProductsContainer.js");
/* harmony import */ var _CartContainer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./CartContainer */ "./src/containers/CartContainer.js");
...
const App = () => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
  'div',
  { className: 'mx-auto', style: { width: "32em" } },
  react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
    'h4',
    { className: 'text-center alert alert-danger' },
    '\uD83C\uDF53\u30D5\u30EB\u30FC\u30C4\u5E02\u5834\uD83C\uDF48'
  ),
  react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ProductsContainer__WEBPACK_IMPORTED_MODULE_1__["default"], null),
  react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_CartContainer__WEBPACK_IMPORTED_MODULE_2__["default"], null)
);
...
const CartContainer = ({ products, total, checkout }) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Cart__WEBPACK_IMPORTED_MODULE_4__["default"], {
  products: products,
  total: total,
...
CartContainer.propTypes = {
  products: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.shape({
    id: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number.isRequired,
    title: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string.isRequired,
    price: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number.isRequired,
    quantity: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number.isRequired
  })).isRequired,
  total: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string.isRequired,
  checkout: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func.isRequired
};
const mapStateToProps = state => ({
  products: Object(_reducers__WEBPACK_IMPORTED_MODULE_3__["getCartProducts"])(state),
  total: Object(_reducers__WEBPACK_IMPORTED_MODULE_3__["getTotal"])(state)
});

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])(mapStateToProps, { checkout: _actions__WEBPACK_IMPORTED_MODULE_5__["checkout"] })(CartContainer));
...
/* harmony import */ var _reducers_products__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../reducers/products */ "./src/reducers/products.js");
...
/* harmony import */ var _components_ProductsList__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/ProductsList */ "./src/components/ProductsList.js");
...
const ProductsContainer = ({ products, displayState, addToCart }) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
    _components_ProductsList__WEBPACK_IMPORTED_MODULE_6__["default"],
    { title: '\u5546\u54C1\u4E00\u89A7', onClick_displayState: () => displayState() },
    products.map(product => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_ProductItem__WEBPACK_IMPORTED_MODULE_5__["default"], {
        key: product.id,
        product: product,
...
ProductsContainer.propTypes = {
    ...
    displayState: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func.isRequired,
    ...
    return {
        products: Object(_reducers_products__WEBPACK_IMPORTED_MODULE_4__["getVisibleProducts"])(state.products)
    };
};

/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_2__["connect"])(mapStateToProps, { displayState: _actions__WEBPACK_IMPORTED_MODULE_3__["displayState"], addToCart: _actions__WEBPACK_IMPORTED_MODULE_3__["addToCart"] })(ProductsContainer));
...
/* harmony import */ var _containers_App__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./containers/App */ "./src/containers/App.js");
...
const store = Object(redux__WEBPACK_IMPORTED_MODULE_2__["createStore"])(_reducers__WEBPACK_IMPORTED_MODULE_5__["default"], Object(redux__WEBPACK_IMPORTED_MODULE_2__["applyMiddleware"])(redux_thunk__WEBPACK_IMPORTED_MODULE_4__["default"]));
store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_6__["getAllProducts"])());
// store.subscribe(
...
react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
    ...
    { store: store },
    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_containers_App__WEBPACK_IMPORTED_MODULE_7__["default"], null)
...
/*!******************************!*\
  !*** ./src/reducers/cart.js ***!
  \******************************/
/*! exports provided: getAddedIds, getQuantity, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAddedIds", function() { return getAddedIds; });
...
const initialState = {
    ...
    switch (action.type) {
        case _constants_ActionTypes__WEBPACK_IMPORTED_MODULE_0__["ADD_TO_CART"]:
...
const cart = (state = initialState, action) => {
    switch (action.type) {
        case _constants_ActionTypes__WEBPACK_IMPORTED_MODULE_0__["CHECKOUT_REQUEST"]:
            return initialState;
        case _constants_ActionTypes__WEBPACK_IMPORTED_MODULE_0__["CHECKOUT_FAILURE"]:
            console.log("決済に失敗しました。");
            return action.cart;
        // ADD_TO_CARTはこちら
        case _constants_ActionTypes__WEBPACK_IMPORTED_MODULE_0__["CHECKOUT_SUCCESS"]:
...
/*!*******************************!*\
  !*** ./src/reducers/index.js ***!
  \*******************************/
/*! exports provided: default, getCartProducts, getTotal */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var redux__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! redux */ "./node_modules/redux/es/redux.js");
/* harmony import */ var _products__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./products */ "./src/reducers/products.js");
/* harmony import */ var _cart__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cart */ "./src/reducers/cart.js");
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
const getAddedIds = state => _cart__WEBPACK_IMPORTED_MODULE_2__["getAddedIds"](state.cart);
const getQuantity = (state, id) => _cart__WEBPACK_IMPORTED_MODULE_2__["getQuantity"](state.cart, id);
const getProduct = (state, id) => _products__WEBPACK_IMPORTED_MODULE_1__["getProduct"](state.products, id);

/* harmony default export */ __webpack_exports__["default"] = (Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({ products: _products__WEBPACK_IMPORTED_MODULE_1__["default"], cart: _cart__WEBPACK_IMPORTED_MODULE_2__["default"] }));

const getCartProducts = state => {
    return getAddedIds(state).map(id => _extends({}, getProduct(state, id), {
        quantity: getQuantity(state, id)
    }));
};

const getTotal = state => {
    return getAddedIds(state).reduce((total, id) => total + getProduct(state, id).price * getQuantity(state, id), 0).toFixed();
};
...
/*!**********************************!*\
  !*** ./src/reducers/products.js ***!
  \**********************************/
/*! exports provided: default, getProduct, getVisibleProducts */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const products = (state, action) => {
    ...
    switch (action.type) {
        case _constants_ActionTypes__WEBPACK_IMPORTED_MODULE_1__["ADD_TO_CART"]:
            return _extends({}, state, {
...
const byId = (state = {}, action) => {
    switch (action.type) {
        case _constants_ActionTypes__WEBPACK_IMPORTED_MODULE_1__["RECEIVE_PRODUCTS"]:
            return _extends({}, state, action.products.reduce((obj, product) => {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(redux__WEBPACK_IMPORTED_MODULE_0__["combineReducers"])({ byId, visibleIds }));
