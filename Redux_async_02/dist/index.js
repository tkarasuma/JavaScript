...
/*!******************************!*\
  !*** ./src/actions/index.js ***!
  \******************************/
/*! exports provided: REQUEST_POSTS, RECEIVE_POSTS, SELECT_WORD, INVALIDATE_WORD, selectWord, requestPosts, receivePosts, invalidateWord, fetchPostsIfNeeded */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const fetchPosts = word => d => {
    d(requestPosts(word));
    fetch(`https://www.reddit.com/r/${word}.json`).then(res => res.json()).then(json => d(receivePosts(word, json)));
};
...
const fetchPostsIfNeeded = word => (d, g) => {
