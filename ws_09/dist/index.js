...
var _reducer = __webpack_require__(/*! ./reducer */ "./node_modules/redux-undo/lib/reducer.js");
...
var _debug = __webpack_require__(/*! ./debug */ "./node_modules/redux-undo/lib/debug.js");
...
var _UndoRedo = __webpack_require__(/*! ../containers/UndoRedo */ "./src/containers/UndoRedo.js");
...
var Link = function Link(_ref) {
    ...
    if (active) {
        return _react2.default.createElement(
            'div',
            { className: "btn btn-warning  w-25 mr-2" },
            children
        );
    } else {
        return _react2.default.createElement(
            'div',
            { className: "btn btn-outline-secondary w-25 mr-2", onClick: function onClick(e) {
                    e.preventDefault();
                    _onClick();
                } },
            children
...
var Todo = function Todo(_ref) {
    ...
    return _react2.default.createElement(
        'li',
        { className: completed ? "list-group-item bg-secondary text-dark" : "list-group-item", onClick: onClick },
        text
    );
};
...
var TodoList = function TodoList(_ref) {
    ...
    return _react2.default.createElement(
        'ul',
        { className: 'list-group mx-auto p-3 bg-info rounded', style: { maxWidth: '36rem' } },
...
var AddTodo = function AddTodo(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'todo_name', placeholder: 'Todo\u306E\u540D\u79F0', ref: function ref(node) {
                input = node;
            } }),
        _react2.default.createElement(
            'button',
            { className: 'btn btn-primary btn-lg btn-block mt-1', onClick: function onClick() {
                    dispatch((0, _index.addTodo)(input.value));input.value = "";
                } },
            '\u65B0\u898F\u8FFD\u52A0'
        )
    );
...
var _reduxUndo = __webpack_require__(/*! redux-undo */ "./node_modules/redux-undo/lib/index.js");
...
var UndoRedo = function UndoRedo(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'button',
            { className: 'btn btn-info mr-3', onClick: onUndo, disabled: !canUndo },
            '\u5143\u306B\u623B\u3059'
        ),
        _react2.default.createElement(
            'button',
            { className: 'btn btn-info', onClick: onRedo, disabled: !canRedo },
            '\u3084\u308A\u76F4\u3059'
        )
    );
};
...
var mapDispatchToProps = {
    onUndo: _reduxUndo.ActionCreators.undo,
    onRedo: _reduxUndo.ActionCreators.redo
};
...
store.dispatch((0, _actions.addTodo)('Todo 1番目'));
store.dispatch((0, _actions.addTodo)('Todo 2番目'));
store.dispatch((0, _actions.addTodo)('Todo 3番目'));
store.dispatch((0, _actions.addTodo)('Todo 4番目'));
store.dispatch((0, _actions.addTodo)('Todo 5番目'));
store.dispatch((0, _actions.toggleTodo)(1));
store.dispatch((0, _actions.toggleTodo)(3));
...
var _todo = __webpack_require__(/*! ./todo */ "./src/reducers/todo.js");
...
var todoApp = (0, _redux.combineReducers)({ todos: _todo2.default, visibilityFilter: _visibilityFilter2.default });
...
var undoableTodos = (0, _reduxUndo2.default)(todos, { filter: (0, _reduxUndo.includeAction)(['ADD_TODO', 'TOGGLE_TODO']) });
