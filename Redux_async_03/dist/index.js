...
/******/ 	__webpack_require__.p = "C:\\Users\\Taro\\Desktop\\ws\\dist";
/******/
/******/
...
/*!******************************!*\
  !*** ./src/actions/index.js ***!
  \******************************/
/*! exports provided: REQUEST_POSTS, RECEIVE_POSTS, SELECT_WORD, INVALIDATE_WORD, selectWord, invalidateWord, requestPosts, receivePosts, fetchPostsIfNeeded */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SELECT_WORD", function() { return SELECT_WORD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INVALIDATE_WORD", function() { return INVALIDATE_WORD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "selectWord", function() { return selectWord; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "invalidateWord", function() { return invalidateWord; });
...
const INVALIDATE_WORD = 'INVALIDATE_Word';
...
const requestPosts = word => ({
  type: REQUEST_POSTS,
  word
});
// RECEIVE_POSTS アクションを返す
const receivePosts = (word, json) => ({
  type: RECEIVE_POSTS,
  word,
...
const fetchPosts = word => dispatch => {
  ...
  fetch(`https://www.reddit.com/r/${word}.json`).then(response => response.json()).then(json => dispatch(receivePosts(word, json)));
};
// 新たにデータを取得するか否か
...
const fetchPostsIfNeeded = word => (dispatch, getState) => {
...
const Picker = ({ value, onChange, options }) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
  'span',
  null,
  ...
  react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
    ...
    { className: 'form-control', onChange: e => onChange(e.target.value),
      value: value },
    options.map(option => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
      'option',
...
Picker.propTypes = {
  options: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.arrayOf(prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string.isRequired).isRequired,
...
const Posts = ({ posts }) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
  'ul',
  null,
  posts.map((post, i) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
    'li',
    { key: i },
    post.title
  ))
...
/* harmony import */ var _components_Picker__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/Picker */ "./src/components/Picker.js");
...
class App extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(...args) {
    ...
    return _temp = super(...args), this.handleChange = nextWord => {
      this.props.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_3__["selectWord"])(nextWord));
    }, this.handleRefreshClick = e => {
      e.preventDefault();

      const { dispatch, selectedWord } = this.props;

      dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_3__["invalidateWord"])(selectedWord));
      dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_3__["fetchPostsIfNeeded"])(selectedWord));
    }, _temp;
  }
  ...
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
      'div',
      null,
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Picker__WEBPACK_IMPORTED_MODULE_4__["default"], { value: selectedWord,
        onChange: this.handleChange,
        options: ['tokyo', 'osaka', 'kyoto'] }),
      react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        'p',
        null,
        lastUpdated && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
          'span',
          null,
          '\u6700\u7D42\u66F4\u65B0\u65E5',
        ...
        !isFetching && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
          'button',
          { className: 'btn btn-warning mt-2', onClick: this.handleRefreshClick },
          '\u518D\u8AAD\u8FBC\u307F'
        )
      ),
      isEmpty ? isFetching ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        'h2',
        null,
        '\u30ED\u30FC\u30C9\u4E2D...'
      ) : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_Posts__WEBPACK_IMPORTED_MODULE_5__["default"], { posts: posts })
      )
    );
  }
}
...
App.propTypes = {
  selectedWord: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.string.isRequired,
  posts: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.array.isRequired,
  isFetching: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.bool.isRequired,
  lastUpdated: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.number,
...
Object(react_dom__WEBPACK_IMPORTED_MODULE_1__["render"])(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
  ...
  { store: store },
  react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_containers_App__WEBPACK_IMPORTED_MODULE_6__["default"], null)
...
const selectedWord = (state = 'tokyo', action) => {
  ...
  switch (action.type) {
    ...
    case _actions__WEBPACK_IMPORTED_MODULE_1__["SELECT_WORD"]:
      return action.word;
    default:
      return state;
  }
...
const posts = (state = {
  ...
  switch (action.type) {
    ...
    case _actions__WEBPACK_IMPORTED_MODULE_1__["INVALIDATE_WORD"]:
      return _extends({}, state, {
        didInvalidate: true
        // 読み込みリクエストを、ダウンロード完了前は
        //  isFetchingをtrue
        // didInvalidate をfalse
      });case _actions__WEBPACK_IMPORTED_MODULE_1__["REQUEST_POSTS"]:
      return _extends({}, state, {
        isFetching: true,
        didInvalidate: false
        //非同期でデータ取得後はitemsに格納
      ...
      });case _actions__WEBPACK_IMPORTED_MODULE_1__["RECEIVE_POSTS"]:
      return _extends({}, state, {
        isFetching: false,
        didInvalidate: false,
        items: action.posts,
