    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            { className: 'btn btn-primary btn-lg btn-block mt-1', onClick: function onClick() {
                    dispatch((0, _index2.default)(input.value));input.value = "";
                } },
            '\u65B0\u898F\u8FFD\u52A0'
        )
    );
...
store.dispatch((0, _actions2.default)('Todo 1番目'));
store.dispatch((0, _actions2.default)('Todo 2番目'));
store.dispatch((0, _actions2.default)('Todo 3番目'));
store.dispatch((0, _actions2.default)('Todo 4番目'));
store.dispatch((0, _actions2.default)('Todo 5番目'));
